...
export default async function (hre: HardhatRuntimeEnvironment) {
  ...
  const artifact = await deployer.loadArtifact("OptimizedSimpleOracle");
  ...
  if (process.env.NODE_ENV != "test") {
    ...
    const contractFullyQualifedName = "contracts/OptimizedSimpleOracle.sol:OptimizedSimpleOracle";
